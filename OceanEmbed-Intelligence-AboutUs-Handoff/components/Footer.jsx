      ...
      <div className="footer-layout">
        ...
        <div className="footer-nav-groups">
          <div className="footer-nav-col">
            ...
            <Link href="/intelligence">Ocean Intelligence</Link>
            <Link href="/model">Model</Link>
            <Link href="/about-us">About Us</Link>
          </div>
          <div className="footer-nav-col">
            <h4>OCEAN DATA</h4>
            <Link href="/about-us">Argo Floats</Link>
            <Link href="/about-us">GLORYS Reanalysis</Link>
            <Link href="/model">Integration</Link>
          </div>
          <div className="footer-nav-col">
            <h4>RESOURCES</h4>
            <Link href="/solution">Architecture</Link>
            <Link href="/model">Documentation</Link>
            <Link href="/about-us">Data Ingestion</Link>
          </div>
        </div>
