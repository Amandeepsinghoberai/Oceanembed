...
file_path = 'ostia_tile_60_90_5_35_2026-09-07.nc'
...
num_cells = len(lat) * len(lon)
f32_size = num_cells * 4 / (1024 * 1024)
print("-" * 30)
print(f"Approximate number of native cells: {num_cells:,}")
print(f"Raw Float32 size (MB): {f32_size:.2f}")
print(f"Approximate compressed NetCDF size (MB): {file_size_mb:.2f}")
